...
const AddEomForm = ({onNewEom=f=>f}) => {
        ...
        <form className='flex flexColumn' onSubmit={submit}>
                ...
                <input ref={input => _fourthKeywordClicks = input } 
                        type="text"
                        placeholder='4th Keyword Clicks'/>
